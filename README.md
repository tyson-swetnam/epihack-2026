...
> **📦 Archived — May 2026.** EpiHack Arizona 2026 has concluded; this
> repository is preserved as a known-good baseline for future revival.
> The full archival journey lives at
> <https://tyson-swetnam.github.io/epihack-2026/docs/>; see
> [`plan/10-archival-and-docs.md`](plan/10-archival-and-docs.md) for the
> archival plan, the [Ansible audit](plan/ANSIBLE-AUDIT-2026-05-23.md)
> for the deployable-state snapshot, and
> [`CITATION.cff`](CITATION.cff) for citation metadata. The live demo at
> <http://epihack-test.cis240692.projects.jetstream-cloud.org/> remains
> up on a Jetstream2 VM as a reference deployment.
>
> **What's here, where it lives:** UI/UX journey at
> [`docs/journey/`](docs/journey/) (seven pages, including the
> [vibe-coding history](docs/journey/07-vibe-coding.md)); reference site
> generated by MkDocs Material at [`docs/`](docs/); reproducible
> end-to-end stack via [`ansible/`](ansible/); all 15 components
> (11 MCPs + agents + app + openapi + docs) green at archive freeze
> per [`docs/reference/test-matrix.md`](docs/reference/test-matrix.md).
>
> **To revive:** `ansible-playbook -i inventory.yml playbook.yml`
> against a fresh Ubuntu 24.04 box; see
> [`docs/deploy/ansible.md`](docs/deploy/ansible.md).
